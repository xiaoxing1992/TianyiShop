...
public class QrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView qr_back_iv = (ImageView) findViewById(R.id.qr_back_iv);

        //生成二维码
        Bitmap bitmap = generateBitmap("http://www.yunifang.com/index.html", 800, 800);

        //先得到一个logo图标
        Bitmap logoBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);
        //把logo添加到二维码上
        Bitmap customBitmap = addLogo(bitmap, logoBitmap);
        qr_img.setImageBitmap(customBitmap);

        qr_back_iv.setOnClickListener(new View.OnClickListener() {
            @Override
